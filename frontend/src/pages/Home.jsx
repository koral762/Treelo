...
export function Home() {
    return (
        <section className="home flex column align-center justify-center" >
            ...
            <section className="welcome-container hero flex justify-space-between">
                ...
                <div className="img-container">
                    <img src={HeroImg} className="slide-left home-img" />
                </div>
            </section>
            ...
            <section className="about-wrapper flex column">
                <h2 className="about-us-title">Contact me</h2>
                <div className="about-us-container flex justify-center align-center wrap">
                    ...
                    <div className="about-me-container">
                        ...
                        <hr></hr>
                        <h5>koral762@gmail.com | 050-7620101</h5>
